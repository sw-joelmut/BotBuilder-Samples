...
- In a terminal, navigate to the following directory:
  ```bash
  cd sample\javascript_nodejs\05.multi-turn-prompt
  ```

  **Optional:** Update the `.env` file under `sample\javascript_nodejs\05.multi-turn-prompt` with your **botFileSecret**.
