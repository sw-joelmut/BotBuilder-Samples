...
- [Concepts introduced in this sample](#concepts-introduced-in-this-sample)
  ...
  * [Adding media to messages](#adding-media-to-messages)
...
## Run the Sample
### Visual Studio
- Navigate to the samples folder `sample\csharp_dotnetcore\07.using-adaptive-cards` and open **AdaptiveCardsBot.csproj** in Visual Studio 
- From the **Startup Projects** select `AdaptiveCardsBot`
- Run the project (press `F5` key)

### Visual Studio Code
- In Visual Studio Code open the `sample\csharp_dotnetcore\07.using-adaptive-cards` folder
